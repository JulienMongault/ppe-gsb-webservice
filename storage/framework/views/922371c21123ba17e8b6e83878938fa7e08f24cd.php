<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="/gsb/public/images/ico-gsb.png" />
    </head>
    <body>
        <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>"><img class="logo-gsb" src="/gsb/public/images/logo-gsb.png" /></a>
            &nbsp;
...
<?php /**PATH C:\wamp64\www\gsb\resources\views/template.blade.php ENDPATH**/ ?>